...
#include "generateCode.h"//added by zhuqi
int linenumber = 1;
AST_NODE *prog;
...
static const yytype_uint16 yyrline[] =
{
     ...
     512,   517,   521,   527,   533,   538,   544,   548,   555,   559,
...
char *argv[];
{
    ...
    /* TODO: Generate ARM64 code from the AST */
    
    // Write your own code
    // i.e. generateCode(prog)
    generateCode(prog);//added by zhuqi
